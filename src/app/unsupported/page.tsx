...
const Unsupported: React.FC = () => (
  <div className="h-screen flex items-center justify-center flex-col space-y-6">
    ...
    <div className="flex space-x-4">
      {/* Play Store Button */}
      <a title="play_store" href="https://play.google.com/store/apps/details?id=com.nishant.blyp" target="_blank"  rel="noopener noreferrer">
        <Image src="/images/playstore_icon.png" alt="Get it on Google Play" width={200} height={50} />
      </a>

      {/* App Store Button */}
      <a title="app_store" href="https://apps.apple.com/in/app/blyp-smart-move/id6745582429" target="_blank" rel="noopener noreferrer">
